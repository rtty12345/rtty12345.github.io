...
GrowPlant: function (l, d, c, e, b) { // 推荐换成如下种植函数，可以适配未重写关的 GrowPlant，还支持流星雨卡槽
    ...
    SetNextWaveZombies : function(survival_times) {
        ...
        switch(survival_times){case 3:AZ=[[oZombie,2,1],[oZombie3,2,1],[oConeheadZombie,2,1]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:[10,11,12,13,25,13,14,15,17,30]};break;
                ...
                case 9:AZ=[[oZombie,2,1],[oZombie3,1,1],[oFootballZombie,1,4],[oZomboni,1,6],[oJackinTheBoxZombie,1,11],[oDiggerZombie,1,9]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:[39,40,41,43,65,45,46,47,49,70]};break;
                case 11:AZ=[[oZombie,2,1],[oZombie3,1,1],[oBucketheadZombie,1,2],[oScreenDoorZombie,1,3],[oJackinTheBoxZombie,1,2],[oDiggerZombie,1,7]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:[50,51,52,53,70,55,56,57,59,75]};break;
                ...
                case 15:AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,1,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oZomboni,1,1],[oJackinTheBoxZombie,1,1],[oBalloonZombie,1,1],[oDiggerZombie,1,2]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:[70,71,72,73,90,75,76,77,79,95]};break;
                case 17:AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,1,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oZomboni,1,1],[oJackinTheBoxZombie,1,1],[oBalloonZombie,1,1],[oDiggerZombie,1,2]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:[80,83,85,89,100,90,93,95,97,110]};break;
                default:rn=Math.floor(Math.random()*100);if(rn<=3){AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,1,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oDiggerZombie,1,2]];FlagToSumNum={a1:[4,9,10,14,19],a2:[80,100,110,90,100,120]};}
...
GrowPlant: function (l, d, c, e, b) { // 推荐换成如下种植函数，可以适配未重写关的 GrowPlant，还支持流星雨卡槽
    ...
    SetNextWaveZombies : function(survival_times) {
        ...
        switch(survival_times){case 3:AZ=[[oZombie,2,1],[oZombie3,2,1],[oConeheadZombie,2,1]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:[10,11,12,13,25,13,14,15,17,30]};break;
                ...
                case 11:AZ=[[oZombie,2,1],[oZombie3,1,1],[oBucketheadZombie,1,2],[oScreenDoorZombie,1,3],[oJackinTheBoxZombie,1,2],[oDiggerZombie,1,5]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:[50,51,52,53,70,55,56,57,59,75]};break;
                case 13:AZ=[[oZombie,1,1],[oZombie2,0,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,1,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oDiggerZombie,1,9]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:[60,61,62,63,80,65,66,67,69,85]};break;
                case 15:AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,1,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oJackinTheBoxZombie,1,1],[oBalloonZombie,1,1],[oDiggerZombie,1,5]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:[70,71,72,73,90,75,76,77,79,95]};break;
                case 17:AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,1,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oJackinTheBoxZombie,1,1],[oBalloonZombie,1,1],[oDiggerZombie,1,4]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:[80,83,85,89,100,90,93,95,97,110]};break;
...
oS.Init({
    ...
    AZ: [[oZombie, 2, 1],[oZombie3, 2, 1], [oConeheadZombie, 2, 4], [oBucketheadZombie, 1, 7], [oDuckyTubeZombie1, 1, 5], [oDuckyTubeZombie2, 0, 6], [oDuckyTubeZombie3, 0, 9]],
    FlagNum: 20,
    FlagToSumNum: {
        a1: [   3, 6,  9, 10, 12, 14, 17, 19],
        a2: [1, 2, 3, 10,  4,  5,  6,  7, 15]
...
GrowPlant: function (l, d, c, e, b) { // 推荐换成如下种植函数，可以适配未重写关的 GrowPlant，还支持流星雨卡槽
    ...
    GotoNextWave : function(survival_times){
        ...
        else if(rn<=20){AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,2,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oDuckyTubeZombie1,1,1],[oDuckyTubeZombie2,0,1],[oDuckyTubeZombie3,0,1],[oDolphinRiderZombie,1,1],[oSnorkelZombie,1,1],[oZomboni,1,1],[oJackinTheBoxZombie,1,1],[oDiggerZombie,1,6]];FlagToSumNum={a1:[4,9,10,14,19],a2:[120,130,160,120,130,170]};}
        else if(rn<=30){AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,2,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oDuckyTubeZombie1,1,1],[oDuckyTubeZombie2,0,1],[oDuckyTubeZombie3,0,1],[oDolphinRiderZombie,1,1],[oSnorkelZombie,1,1],[oZomboni,1,1],[oBalloonZombie,1,1],[oDiggerZombie,1,4]];FlagToSumNum={a1:[4,9,10,14,19],a2:[120,130,160,120,130,170]};}
        else{AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,1,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oDuckyTubeZombie1,1,1],[oDuckyTubeZombie2,0,1],[oDuckyTubeZombie3,0,1],[oDolphinRiderZombie,1,1],[oSnorkelZombie,1,1],[oZomboni,1,1],[oJackinTheBoxZombie,1,1],[oBalloonZombie,1,1],[oDiggerZombie,1,2]];FlagToSumNum={a1:[4,9,10,14,19],a2:[120,130,160,120,130,170]};}break;};
        oP.Init({
            AZ: AZ,
            FlagToSumNum: FlagToSumNum,
            FlagToEnd: oP.FlagToEnd,
...
GrowPlant: function (l, d, c, e, b) { // 推荐换成如下种植函数，可以适配未重写关的 GrowPlant，还支持流星雨卡槽
    ...
    SetNextWaveZombies : function(survival_times) {
        ...
        case 3:AZ=[[oZombie,2,1],[oZombie3,2,1],[oConeheadZombie,2,1],[oDolphinRiderZombie,1,8],[oDuckyTubeZombie1,1,3],[oDuckyTubeZombie2,0,3],[oDuckyTubeZombie3,0,4]];FlagToSumNum={a1:[3,6,8,9,10,13,15,18,19],a2:
        default:rn=Math.floor(Math.random()*100);if(rn<=3){AZ=[[oZombie,1,1],[oZombie2,0,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,1,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oDuckyTubeZombie1,1,1],[oDuckyTubeZombie2,0,1],[oDuckyTubeZombie3,0,1],[oDolphinRiderZombie,1,1],[oSnorkelZombie,1,1]];FlagToSumNum={a1:[4,9,10,14,19],a2:[80,100,110,90,100,120]};
        }else if(rn<=4){AZ=[[oDuckyTubeZombie1,1,1],[oDuckyTubeZombie2,0,1],[oDuckyTubeZombie3,0,1],[oDolphinRiderZombie,1,1],[oSnorkelZombie,1,1],[oZomboni,1,1],[oJackinTheBoxZombie,1,1],[oBalloonZombie,1,1]];FlagToSumNum={a1:[4,9,10,14,19],a2:[150,160,190,150,160,190]}
        }else if(rn<=5){choseZombie=oS.ZName[Math.floor(Math.random()*(oS.ZName.length-1)+1)],lvl=choseZombie.prototype.Lvl;AZ=[[choseZombie,5,1]];FlagToSumNum={a1:[4,9,10,14,19],a2:[lvl*35,lvl*45,lvl*50,lvl*35,lvl*45,lvl*50]};
        }else if(rn<=20){AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,2,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oDuckyTubeZombie1,1,1],[oDuckyTubeZombie2,0,1],[oDuckyTubeZombie3,0,1],[oDolphinRiderZombie,1,1],[oSnorkelZombie,1,1],[oZomboni,1,1],[oJackinTheBoxZombie,1,1],[oDiggerZombie,1,4]];FlagToSumNum={a1:[4,9,10,14,19],a2:[120,130,160,120,130,170]};
        }else if(rn<=30){AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,2,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oDuckyTubeZombie1,1,1],[oDuckyTubeZombie2,0,1],[oDuckyTubeZombie3,0,1],[oDolphinRiderZombie,1,1],[oSnorkelZombie,1,1],[oZomboni,1,1],[oBalloonZombie,1,1],[oDiggerZombie,1,3]];FlagToSumNum={a1:[4,9,10,14,19],a2:[120,130,160,120,130,170]};
        }else{AZ=[[oZombie,1,1],[oZombie3,0,1],[oPoleVaultingZombie,1,1],[oConeheadZombie,1,1],[oBucketheadZombie,1,1],[oNewspaperZombie,1,1],[oScreenDoorZombie,1,1],[oFootballZombie,1,1],[oDancingZombie,1,1],[oDuckyTubeZombie1,1,1],[oDuckyTubeZombie2,0,1],[oDuckyTubeZombie3,0,1],[oDolphinRiderZombie,1,1],[oSnorkelZombie,1,1],[oZomboni,1,1],[oJackinTheBoxZombie,1,1],[oBalloonZombie,1,1],[oDiggerZombie,1,2]];FlagToSumNum={a1:[4,9,10,14,19],a2:[120,130,160,120,130,170]};}break;};
        oP.Init({
            AZ: AZ,
            FlagToSumNum: FlagToSumNum,
