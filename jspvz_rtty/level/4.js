oS.Init({
	...
	StartGame: function() {
		...
		(function(e, h, b, d, c, g, a, f) {
			...
			e < 990 ? oSym.addTask(3, arguments.callee, [e, h, b, d, c, g, a, f]) : (StopAudio("dirt_rise", true), ClearChild($("SodRoll_1"), $("SodRoll_2"), $("SodRollCap_1"), $("SodRollCap_2")), (function() {
				StopMusic();
	...
	FlagToEnd: function() {
		(NewImg("imgSF", "images/interface/Shovel.png", "left:667px;top:330px;cursor:pointer", EDAll)).onclick = function() {
