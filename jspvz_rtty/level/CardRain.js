...
/*
种子雨核心函数，需要者自取，但我更希望内嵌入 jspvz

var AppearCard = function (h, f, e, a, t) { // x, y, 植物id, 移动卡槽类型, 消失时间（默认 15s）
...
oS.Init({
	PName: [oLilyPad, oLilyPad, oLilyPad, oPeashooter, oCherryBomb, oWallNut, oPotatoMine, oSnowPea, oChomper, oRepeater, oPuffShroom, oFumeShroom, oHypnoShroom, oScaredyShroom, oIceShroom, oDoomShroom,oGraveBuster,oSquash,oThreepeater,oTangleKelp,oJalapeno,oSpikeweed,oTorchwood,oTallNut,oSeaShroom,oPlantern,oCactus,oBlover,oSplitPea,oStarfruit,oPumpkinHead,oGarlic],
	...
	StartGame: function() {
		...
		(function(){ // 隐藏原卡槽
			var c = $("dCardList");
			for (var a = 0, b; b = c.childNodes.item(a); ++a) SetHidden(b);
		})();

		oS.InitLawnMower(), PrepareGrowPlants(function () {
	...
	FlagToSumNum: {
		...
		a2: [1, 2, 4, 10,  6,  8, 10, 25, 13, 16, 19, 40, 22, 25, 58, 108]
	},
	FlagToMonitor: {
		9: [ShowLargeWave, 0],
		19: [ShowLargeWave, 0],
