...
*/
oS.Init({
        PName: [oFumeShroom, oPumpkinHead, oHypnoShroom, oPotatoMine, oSunFlower, oThreepeater, oGatlingPea, oCactus, oLilyPad,oRepeater],
        ...
        ArP: {
                ...
                P: {
                        Arr: [0, 0, 0, 0, 0, 2, 2, 2, 2, 2, 2,2,4,4,4,4,4,5,6,6,6,6,7,7,8], 
