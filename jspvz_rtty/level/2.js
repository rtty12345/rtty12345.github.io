oS.Init({
	...
	StartGame: function() {
		...
		(function(e, h, b, d, c, g, a, f) {
			...
			e < 766 ? oSym.addTask(3, arguments.callee, [e, h, b, d, c, g, a, f]) : (StopAudio("dirt_rise", true), ClearChild($("SodRoll_1"), $("SodRoll_2"), $("SodRollCap_1"), $("SodRollCap_2")), (function() {
				StopMusic();
