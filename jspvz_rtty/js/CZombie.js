	...
	PrivateAct: function(a){
            oSym.addTask(1,function(a){
			    ...
			    p&&!p.Freeze&&((p.EName != "oLawnCleaner") && (p.EName != "oPoolCleaner") && (p.EName != "oBrains")&& (p.EName != "oSpikeweed")&& (p.EName != "oSnowPea")&& (p.EName != "oTorchwood")&& (p.EName != "oSpikerock")&&(p.EName!="oIceShroom")&&(p.EName!="oJalapeno"))&& ($(p.id).childNodes[1].src =p.PicArr[p.StaticGif],
			      NewImg("icetrap_" + Math.random(), "images/Plants/IceShroom/icetrap.gif", p.getShadow(p), $(p.id)),p.SetAlpha(p,$(p.id),30,0.3),p.NormalAttack=function(){},p.Freeze=1,
...
oDiggerZombie = InheritO(OrnNoneZombies, {
  ...
  CanDig: {
    oWallNut,oPotatoMine,oChomper,oSpikerock,oSpikeweed: true
  },
