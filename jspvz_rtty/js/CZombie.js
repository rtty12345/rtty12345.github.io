...
oNewspaperZombie2= InheritO(OrnIIZombies, {
	...
	PicArr: (function() {
		var a = "images/Zombies/NewspaperZombie/";
		return ["images/Card/Zombies/NewspaperZombie.png", a + "01.gif", a + "HeadWalk1.gif", a + "HeadAttack2.gif", a + "LostHeadWalk1.gif", a + "LostHeadAttack1.gif", a + "HeadWalk2.gif", a + "HeadWalk2.gif", a + "LostHeadWalk2.gif", a + "LostHeadAttack0.gif", a + "Head.gif" + $Random, a + "Die1.gif" + $Random, a + "BoomDie.gif" + $Random, a + "LostNewspaper1.gif", a + "11.gif"]
	})(),
