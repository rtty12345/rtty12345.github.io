            ...
            oSym.addTask(1,function(z,d,a){
                ...
                for(let i = 3;i >= 0;i--){
                    for(let j = 1;j <= C;j++){
                        ...
                        p && (p.canEat) && (p.EName != "oLawnCleaner" && p.EName != "oPoolCleaner" && p.EName != "oBrains" && p.EName != "oPuffShroom" && p.EName != "oSunShroom" && p.EName != "oPotatoMine" && p.EName != "oCherryBomb" && p.EName != "oJalapeno" && p.EName != "oDoomShroom"&& p.EName != "oSunFlower") && (($(p.id).offsetLeft + $(p.id).offsetWidth >= $(d).offsetLeft) && ($(p.id).offsetLeft >= $(d).offsetLeft + $(d).offsetWidth)) && (PlayAudio("potato_mine"),(p.HP -=1800),($(d) && ClearChild($(d))));
...
oFlagZombie = InheritO(oZombie, {
	PicArr: (function() {
		...
		return ["images/Card/Zombies/FlagZombie.png", a + "FlagZombie.gif", a + "FlagZombie.gif",a + "FlagZombie.gif", a + "FlagZombieLostHead.gif", a + "FlagZombieLostHeadAttack.gif", "images/Zombies/Zombie/unlook.gif" + $Random, "images/Zombies/Zombie/ZombieDie.gif" + $Random, "images/Zombies/Zombie/BoomDie.gif" + $Random, a + "1.gif"]
	})(),
	EName: "oFlagZombie",
	CName: "处决者旗帜",
	OSpeed: 10,
...
oFootballZombie = InheritO(oConeheadZombie1,{
	...
	getShadow: function(a) {
		return "left:" + (a.beAttackedPointL + 15) + "px;top:" + (a.height - 22) + "px"
            ...
            let z = $(a.id);
            z.PeaHead = "Pea" + Math.random();
            let pea = NewImg(z.PeaHead,"images/Plants/GatlingPea/GatlingPea.gif","position:absolute;width:80px;height:80px;transform:rotateY(180deg);left:45px;top:15px;",0);
            z.appendChild(pea);
        },
        PrivateAct: function(a){
            if(!a.bool){
            a.bool = 1;
            oSym.addTask(15,function(a){
            let z = $(a.id);
            let div = $n("div");
            let d = "Pea" + Math.random();
            div.id = d;
            ...
            !a.isDie && (a.HP > 60) && oSym.addTask(15,arguments.callee,[a])
            },[a]);
            }
        },
...
oNewspaperZombie = InheritO(OrnIIZombies, {
	...
	CheckOrnHP: function(g, h, d, c, f, b, a) {
		...
		g.EleBody.src = f[g.LostPaperGif] + $Random + Math.random(), g.Ornaments = 0, g.LostHeadGif = 8, g.LostHeadAttackGif = 9,g.Altitude=4,g.getFirePea = e.getFirePea, g.getSnowPea = e.getPea,g.getSlowPea = e.getPea, g.getHit = g.getHit0 = g.getHit1 = g.getHit2 = g.getHit3 = e.getHit, oSym.addTask(300,
		function(m, l) {
			var k = $Z[m];
			if (!k) {
				return
...
oNewspaperZombie2= InheritO(OrnIIZombies, {
	...
	PicArr: (function() {
		var a = "images/Zombies/NewspaperZombie/";
		return ["images/Card/Zombies/NewspaperZombie.png", a + "0.gif", a + "HeadWalk1.gif", a + "HeadAttack1.gif", a + "LostHeadWalk1.gif", a + "LostHeadAttack1.gif", a + "HeadWalk0.gif", a + "HeadAttack0.gif", a + "LostHeadWalk0.gif", a + "LostHeadAttack0.gif", a + "Head.gif" + $Random, a + "Die1.gif" + $Random, a + "BoomDie.gif" + $Random, a + "LostNewspaper1.gif", a + "1.gif"]
	})(),
	...
	CheckOrnHP: function(g, h, d, c, f, b, a) {
		...
		g.EleBody.src = f[g.LostPaperGif] + $Random + Math.random(), g.Ornaments = 0, g.LostHeadGif = 8, g.LostHeadAttackGif = 9,g.getFirePea = e.getFirePea,g.getSnowPea = e.getSnowPea,g.getSlowPea = e.getSlowPea, g.getHit = g.getHit0 = g.getHit1 = g.getHit2 = g.getHit3 = e.getHit,g.Altitude=3,g.Attack=1000000,oSym.addTask(300,
		function(m, l) {
			var k = $Z[m];
			if (!k) {
				return
...
oScreenDoorZombie = InheritO(oNewspaperZombie1, {
	...
	Produce: '他的铁门是非常坚硬的盾牌。<p>韧性：<font color="#FF0000">低(300)</font><br>铁门韧性：<font color="#FF0000">极高（10000）</font><br>弱点：大喷菇和磁力菇</p>made in China!',
	GoingDie: CZombies.prototype.GoingDie,
