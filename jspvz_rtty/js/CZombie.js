        ...
        NormalAttack: function(d, b, g) {
            ...
            oSym.addTask(100, function(m, j, i, l, n) {
                ...
                h && ((k = $P[j]) && k.Stature > 0 ? (h.AttackedRX = (h.X = (h.AttackedLX = h.ZX = q = k.AttackedRX) - h.beAttackedPointL - 400) + h.beAttackedPointR, SetStyle(i, {
                    ...
                    .NormalAttack, h.getCrushed = r.getCrushed, h.getFreeze = r.getFreeze, h.getRaven = r.getRaven) : (h.ZX = h.AttackedLX = (h.X = (h.AttackedRX = g) - h.beAttackedPointR  - 400) + h.beAttackedPointL, SetStyle(i, {
                    left: h.X  + "px",
