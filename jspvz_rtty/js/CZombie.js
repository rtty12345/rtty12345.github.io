...
if(h.HPlook&&!h.bHP){
	h.bHP=1;
    var b = NewEle("dHP", "div", "position:absolute;color:#fff;top:" + (h.pixelTop + 100) + "px;left:" + (h.ZX+60) + "px;width:100%;font-size:12px;z-index:50", "", EDAll);
    var A = "hp" + Math.random();
    dHP.id = A;
    var C = $(A);
    oSym.addTask(1, function(C, h, b) {
	...
	for (let i = (a.R - 1 >= 1 ? a.R - 1 : 1); i <= (a.R + 1 <= oS.R ? a.R + 1 : oS.R); i++) {
      ...
      oSym.addTask(1, function(a) {
        ...
        oSym.addTask(1, function(z, d, a, y) {
            ...
            for (let i = 3; i >= 0; i--) {
              for (let j = 1; j <= C; j++) {
                let p = oGd.$[(!(Left=!y?1:0)?a.R:GetR($(d).offsetTop+30)) + "_" + j + "_" + i];
            ...
            let Z = oZ.getHZ1(pea.offsetLeft + 50,(!(Left=!y?1:0)?a.R:GetR($(d).offsetTop)));
            Z && (Z.Altitude == 1) && ((Z.getPea(Z, 20, 0), ($(d) && ClearChild($(d)))));
	...
	$Z[a.id] && a.beAttacked && (!a.PZ) && oSym.addTask(100, arguments.callee, [a])
      ...
      oSym.addTask(1, function(a) {
        ...
        oSym.addTask(1, function(z, d, a, y) {
            ...
            $(d).style.left = $(d).offsetLeft + 5 + "px";
            $(d).style.top = $(d).offsetTop - y + "px";
            let Z = oZ.getZ0(pea.offsetLeft + 50,(!(Left=!y?1:0)?a.R:GetR($(d).offsetTop)));
            Z && (Z.Altitude == 1) && ((Z.getPea(Z, 20, 0), ($(d) && ClearChild($(d)))));
...
SunNum:2000,
  ...
  ChkActs: function(h, f, j, e) {
    var d, c, g;
    h.Ornaments !== 0 && (h.ZX <= 700) && (h.Speed = h.oSpeed = 0);
    ...
    },
    {
      ...
      func: function(a) {
        ...
        a.PrivateAct = function(a) {
          ...
          $Z[a.id] && oSym.addTask(1500, function(a) {
