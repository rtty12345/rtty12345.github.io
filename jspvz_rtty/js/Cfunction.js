...
oS = {
	...
	LoadTips: function() {
		...
		a = ["本游戏自带调速功能,不信的话你可以去问囧姨!!", "囧姨是谁？囧姨就是囧丫乙！你还不知道囧丫乙？那你总知道Lonelystar吧？她就是囧姨", "为什么没有广告？明知故问。", "告诉你个秘密，很少有改版作者会改“游戏小贴士”。", "这个游戏加载慢？那就去玩原版jspvz吧！", "不会玩?点左下角“点击开始”,再点击右边墓碑上的选项开始玩,初次玩就点“开始冒险吧”", "这游戏是不是给3岁小孩玩的?这么幼稚!亲爱的,如果你玩过原版植物僵尸就不会这么认为了", "这是山寨版?是的,这纯粹就是个人练习程序的产物,后来免费放网上给大家无聊时打发时间的", "这网页版开发速度也太慢了!没错,由于个人业余时间很有限,所以请大家谅解!", "为什么无法注册用户和创建关卡？因为我没有服务器，不过你可以去玩原版jspvz", "初次玩的朋友,请从第一关开始玩起,自然会有教学功能教你一步一步玩下去", "为啥看不到阳光或者僵尸?检查一下你浏览器里的广告杀手功能,也许是它在搞鬼!", "游戏毫无难度?在目前进度下,可以尝试着使用调速功能玩更快的速度", "这里有木有人啊?这儿必须有活人的,打开聊天按钮加入到在线交流行列!", "为啥这么卡?如果你是IE6-8的用户,请使用IE9,Chrome,Firefox,Opera等更好的浏览器!", "原版jspvz广告烦人？大哥，你要吃饭，人家囧姨她也是要吃饭的。", "这是用什么语言写的?javascript,一个简单而又神奇的语言,纯的,JS!"];
