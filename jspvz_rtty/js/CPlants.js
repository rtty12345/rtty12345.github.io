	...
	PrivateBirth: function(c) {
            ...
            oSym.addTask(1,function(c){
                ...
                for(let i = 0;i < z.length;i++){
                    if(z[i].EName == "oSquashZombie" || z[i].EName == "oNewspaperZombie" || z[i].EName == "oNewspaperZombie1" || z[i].EName == "oNewspaperZombie2"|| z[i].EName == "oNewspaperZombie3"|| z[i].EName == "oFlagZombie"|| z[i].EName == "oPoleVaultingZombie1"|| z[i].EName == "oPoleVaultingZombie"|| z[i].EName == "oDolphinRidderZombie"|| z[i].EName == "oZomboni"|| z[i].EName == "oPeaZombie"|| z[i].EName == "oFootballZombie"){
