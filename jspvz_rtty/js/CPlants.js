...
oBlover = InheritO(CPlants, {
	...
	Dispel: function(){ // 吹风
		...
		for(z in $Z) oBalloon = $Z[z], (oBalloon.EName == 'oBalloonZombie,oZombie,oZombie2,oZombie3,oImp,oConeheadZombie,oSmallZombie,oSmallConeheadZombie,oSmallFlagZombie,oSmallFootballZombie,oSmallDuckyTubeZombie1,oSmallSnorkelZombie') && oBalloon.getDispelled(); //把气球吹跑
