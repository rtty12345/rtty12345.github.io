...
oHypnoShroom = InheritO(oFumeShroom, {
	...
	InitTrigger: function() {},
	PrivateBirth:function(b){
         CZ(Math.round(Math.random()*100)>20 ? new oFootballZombie:Math.round(Math.random()*100)>25 ? new oNewspaperZombie: new oNewspaperZombie3,b.R,b.C),
	b&&(b.HP!=0)&&oSym.addTask(3000,arguments.callee,[b])
     }, 
	getHurt: function(d, b, a) {
		var c = this;
		switch (b) {
