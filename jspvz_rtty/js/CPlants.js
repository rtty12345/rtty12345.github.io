...
oIceThreepeater = InheritO(oPeashooter, {
	EName: "oIceThreepeater",
	CName: "三线寒冰射手",
	width: 73,
	height: 80,
	beAttackedPointR: 53,
 ...
 BKind: -1,
	...
	AudioArr: ["splat1", "splat2", "splat3", "plastichit", "shieldhit", "shieldhit2"],
	Tooltip: "一次射出三行的寒冰豌豆",
	Produce: '三线寒冰射手可以在三条线上同时射出寒冰豌豆。<p>伤害：<font color="#FF0000">普通(每颗)</font><br>范围：<font color="#FF0000">三线</font></p>三线寒冰射手出生的时候，他的父母就知道他的命运注定不平凡。',
	getTriggerR: function(a) {
		return [a > 2 ? a - 1 : 1, a < oS.R ? Number(a) + 1 : a]
	},
	PrivateBirth: function(f) {
