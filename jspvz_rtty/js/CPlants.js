...
oPeashooter1= InheritO(CPlants, {
	...
	BKind: 0,
	AudioArr: ["splat1", "splat2", "splat3", "plastichit", "shieldhit", "shieldhit2"],
	PicArr: ["images/Card/Plants/Peashooter.png", "images/Plants/Peashooter/0.gif", "images/Plants/Peashooter/Peashooter.gif", "images/Plants/PB-10.gif", "images/Plants/PeaBulletHit.gif"],
	Tooltip: "向敌人射出豌豆",
...
oGatlingPea= InheritO(oPeashooter, {
	...
	AudioArr: ["splat1", "splat2", "splat3", "plastichit", "shieldhit", "shieldhit2"],
	Tooltip: "一次发射四颗真正的冰豌豆<br>(需要双发射手)，40秒后成长为霰弹枪射手，期间不会受到任何形式伤害",
	Produce: '加特林可以一次发射四颗冰豌豆，40秒后成长为霰弹枪射手，期间不会受到任何形式的伤害<p>伤害：<font color="#FF0000">高(每颗)</font><br>发射速度：<font color="#FF0000"> 4~6倍<br>只能种在双发射手上</font></p>当加特林宣布他要参军的时候，他的父母很为他担心，他们异口同声地对他说：“亲爱的，但这太危险了。”加特林拒绝让步，“生活本就危险，”他这样回答着，此时他的眼睛里，正闪烁着钢铁般的信念。',
	...
	PrivateBirth: function(c) {
            ...
            oSym.addTask(1,function(c){
                ...
                for(let i = 0;i < z.length;i++){
                    if(z[i].EName == "oSquashZombie" || z[i].EName == "oNewspaperZombie" || z[i].EName == "oNewspaperZombie1" || z[i].EName == "oNewspaperZombie2"|| z[i].EName == "oNewspaperZombie3"|| z[i].EName == "oFlagZombie"|| z[i].EName == "oPoleVaultingZombie1"|| z[i].EName == "oPoleVaultingZombie"|| z[i].EName == "oZomboni"|| z[i].EName == "oPeaZombie"|| z[i].EName == "oFootballZombie"){
