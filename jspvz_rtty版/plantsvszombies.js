...
<div id="dSurface" class="WindowFrame">
	...
	<div id="dPause">
		...
		<div class="list">
			<div class="hidden" onclick="SetNone($('dSurface'),$('dPause'))">点我，触发高级暂停</div>
			<div id="dPauseAD"></div>
			<div class="pause">休息，休息亿会儿~</div>
		</div>
	...
	<div id="dSurfaceBack">
		...
		<div id="dOptionsMenuback">
			<div id="dOptionsMenu">
				...
				<div class="BigLevel button" onclick="ShowLevel()">选关卡</div>
				<div class="BigLevel button" onclick="ShowSpeed()">调倍速</div>
				<div class="BigLevel button" onclick="ViewHandBook()">查图鉴</div>
				<div class="BigLevel button" onclick="SelectModal(oS.Lvl)">重新玩</div>
				<div class="BigLevel button" onclick="SelectModal(0);HiddenOptions();SetBlock($('dSurface'),$('iSurfaceBackground'));ShowNameDiv();">主菜单</div>
...
LvlList=function(BLvl,SLvl1,SLvl2){
	...
	do{
		s+='<span class="lvl" onclick="StartAdventure('+(startlvl+SLvl1)+')">LV'+ArLvl[SLvl1]</span>';
	}while(SLvl1++<SLvl2)
	document.write(s);
};
</script>
				...
				<script>
					(function () {
						...
						'DailyLevel','【每日关卡】','DailyLevel.png',
							...
							'FlightOfFancy2','我心飞翔2','woxingfeixiang2.png',
							'FlightOfFancy3','我心飞翔3','woxinfeixiang3.png',
							...
							'jiajuewang','假·绝望','jiajuewang.png',
		...
		<div id="dRiddleSmallContainer" class="TitleSmallContainer Almanac_ZombieBack">
			...
			<div id="dRiddle1">
				...
				<div class="button" onmouseover="this.style.backgroundPosition='bottom'" onmouseout="this.style.backgroundPosition='top'"  onclick="ReturnRiddleInx()">益智模式索引</div>
				<div class="button" style="left:204px" onmouseover="this.style.backgroundPosition='bottom'" onmouseout="this.style.backgroundPosition='top'"  onclick="if($User.Visitor.UserName!='游客'||confirm('本改版此功能无效，若想要体验，\n请去玩原版jspvz！'))SelectModal('ImZombieCreateGame')">创建我是僵尸关卡</div>
			</div>
...
<div class="Announcement">
	...
	<div class="d1" style="width:270px;line-height:30px">
		<marquee onMouseOver="this.stop()" onMouseOut="this.start()"  scrollamount="2">感谢游玩本改版，原作者是囧姨，特别感谢星云的帮助。想玩原版请自己点击：<a href="http://jspvz.com/plantsvszombies.htm">国内服</a>或者<a href="http://lonelystar.org/plantsvszombies.htm">国际服</a></marquee>
	</div>
